// language=hbs
const svgLocationTmpl = `
  <svg class="svg svg-location" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
export default svgLocationTmpl;
